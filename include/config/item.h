...
#define I_EXP_SHARE_FLAG        FLAG_GENERAL_EXP_SHARE   // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
